...
GameFinishedState::GameFinishedState(sf::RenderWindow *window, DataHandler *datahandler,
                                     std::map<std::string, sf::Texture *> *texture_map_ptr,
                                     std::map<std::string, sf::Font *> *font_map_ptr)
    : State(window, datahandler, texture_map_ptr, font_map_ptr, 5)
{
    initMainMenu();
    initBackground();
    initButtons();
...
void GameFinishedState::updateState()
{
    sf::Mouse mouse;
...
void GameFinishedState::initMainMenu()
{
    ...
    menu.addButton(100, 25, 150, 10, transparent, "Game finished!", font);
    menu.addButton(100, 250, 150, 10, transparent, "Stats: ", font);
}

void GameFinishedState::initBackground()
{
...
void GameFinishedState::initButtons()
{
...
void GameFinishedState::updateButtons()
{
